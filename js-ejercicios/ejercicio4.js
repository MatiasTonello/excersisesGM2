...
export function convertirARomano(number) {
  ...
  for (let letraRomana in romanos) {
    numeroRomano += letraRomana.repeat(
      Math.floor(number / romanos[letraRomana])
    ); // Repetimos la letra la cantidad de veces que se pueda diviendo el numero por el valor de la letra
